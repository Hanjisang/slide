  ...
  routes: [
    { path: '/login', component: LoginView, meta: { public: true, title: '登录' } },
    {
      path: '/', component: AppLayout, redirect: '/dashboard', children: [
        ...
        { path: 'quality', component: () => import('./views/QualityView.vue'), meta: { title: '数据清洗转换', permissions: ['QUALITY_MANAGE'] } },
        ...
        { path: 'reports', component: () => import('./views/ReportView.vue'), meta: { title: '医疗数据上报', permissions: ['REPORT_GENERATE','DATA_VIEW'] } },
        { path: 'system', component: () => import('./views/SystemView.vue'), meta: { title: '系统管理', permissions: ['USER_MANAGE','SYSTEM_CONFIG','MONITOR_VIEW','LOG_VIEW','DICT_MANAGE','QUALITY_MANAGE'] } },
      ],
    },
  ],
})
